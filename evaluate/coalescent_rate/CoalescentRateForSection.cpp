...
int 
CoalescentRateForSection(cxxopts::ParseResult& result, const std::string& help_text, std::string chr = "NA"){
...
void
CoalescenceRateForTree(cxxopts::ParseResult& result, const std::string& help_text){
...
void
GenerateConstCoal(cxxopts::ParseResult& result, const std::string& help_text){
