...
void
GetTreeOfInterest(cxxopts::ParseResult& result, const std::string& help_text){
...
void
MapMutation(cxxopts::ParseResult& result, const std::string& help_text){
...
void
UnlinkTips(cxxopts::ParseResult& result, const std::string& help_text){
