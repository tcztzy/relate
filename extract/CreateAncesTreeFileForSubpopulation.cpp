...
void
MakeAncesTreeFile(cxxopts::ParseResult& result, const std::string& help_text, Mutations& mut, std::vector<int>& include_snp){
...
void
CreateAncesTreeFileForSubpopulation(cxxopts::ParseResult& result, const std::string& help_text){
  ...
  MakeAncesTreeFile(result, help_text, mut, include_snp);
  ////////////////////////////////////////////////////////////////////////////////////////////////
  //Propagate mutations
