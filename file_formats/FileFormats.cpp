...
void
ConvertFromHapLegendSample(cxxopts::ParseResult& result, const std::string& help_text){
...
void
ConvertFromVcf(cxxopts::ParseResult& result, const std::string& help_text){
...
void
RemoveNonBiallelicSNPs(cxxopts::ParseResult& result, const std::string& help_text){
...
void
RemoveSamples(cxxopts::ParseResult& result, const std::string& help_text){
...
void
FilterHapsUsingMask(cxxopts::ParseResult& result, const std::string& help_text){
...
void
FlipHapsUsingAncestor(cxxopts::ParseResult& result, const std::string& help_text){
...
void
GenerateSNPAnnotations(cxxopts::ParseResult& result, const std::string& help_text){
